...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/bluetooth-sdk/quickstart">
    Run a complete example app and connect to Mentra Live
  </Card>
  <Card title="Build from Scratch" icon="code" href="/bluetooth-sdk/build-from-scratch">
    Add the SDK to your own mobile app
  </Card>
</CardGroup>
