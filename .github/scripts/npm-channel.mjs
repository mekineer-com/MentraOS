...
// Developer tools use an independent version cadence. Product-family packages
// are stamped by the coordinated release plan and must never enter this map.
...
export function publishedVersions(name) {
  let out
  try {
    out = execFileSync("npm", ["view", name, "versions", "--json", "--registry=https://registry.npmjs.org"], {
      encoding: "utf8",
